...
const jsonLd = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL ?? siteContent.seo.canonical,
  telephone: "+61411918718",
  image: `${process.env.NEXT_PUBLIC_SITE_URL ?? siteContent.seo.canonical}/images/balance-with-maksym-logo-transparent.png`,
